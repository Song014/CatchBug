                ...
                <div class = "row">
                    <div align = "right" class = "dataTable-top">
                        <div class = "dataTable-search">
                            <form action = "/unOrderHistory.do">
                                ...
                                </select> <input type = "text" name = "searchName" placeholder = "검색어를 입력해 주세요.">
                                <button>검색</button>
                            </form>
                        </div>
                    </div>
                    <div class = "dataTable-container">
                        <table class = "table datatable dataTable-table">
                            <tr>
                                <th scope = "col" data-sortable = ""><a href = "#" class = "dataTable-sorter">주문번호</a>
                                </th>
                                <th scope = "col" data-sortable = ""><a href = "#" class = "dataTable-sorter">사업자명</a>
                                </th>
                                <th scope = "col" data-sortable = ""><a href = "#" class = "dataTable-sorter">주문일자</a>
                                </th>
                                <th scope = "col" data-sortable = ""><a href = "#" class = "dataTable-sorter">내용</a>
                                </th>
                                <th scope = "col" data-sortable = ""><a href = "#" class = "dataTable-sorter">비고</a>
                                </th>
                                <th scope = "col" data-sortable = ""><a href = "#" class = "dataTable-sorter">상태</a>
                                </th>
                                <th scope = "col">결제</th>
                            </tr>
                            <c:forEach var = "list" items = "${list }">
                                <tr>
                                    ...
                                    <td><a class = "primary order_detail_member" id = '${list.get("ID")}'
                                    ...
                                    <td><a class = "primary order_detail_modal" id = '${list.get("ORDER_NO")}'
                                           data-bs-toggle = "modal"
                                    ...
                                    <td>
                                        <button type = "button" class = "btn btn-primary btn1"
                                                value = "${list.get('ORDER_NO')}" style = "margin: 0px 10px 0px 10px">승인
                                        </button>
                                        <button type = "button" class = "btn btn-outline-dark btn2"
                                                value = "${list.get('ORDER_NO')}">반려
                                        </button>
                                </tr>
                            </c:forEach>
                        </table>
                        <ul class = "pagination justify-content-center">
                            ...
                            <c:if test = "${pageMaker.prev}">
                                <li>
                                    <a href = "/unOrderHistory.do${pageMaker.makeQuery(pageMaker.startPage-1)}">&laquo;</a>
                                </li>
                            </c:if>
                            ...
                            <c:if test = "${pageMaker.next && pageMaker.endPage > 0}">
                                <li>
                                    <a href = "/unOrderHistory.do${pageMaker.makeQuery(pageMaker.endPage+1)}">&raquo;</a>
                                </li>
                            </c:if>
                        </ul>
                    </div>
                    ...
                    <div class = "card-body">
                        ...
                        <table class = "table">
                            ...
                            <tr>
                                ...
                                <th scope = "col" style = "width: 40%;">상품 이름</th>
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                for (var i = 0; i < result.length; i++) {
                    const price = (result[i].price).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',');
                    str += `
                      <tr style="text-align: center">
                         ...
                         `;
                    orderNo = `<i>주문번호: ` + result[0].order_no + `</i>`;
                }
