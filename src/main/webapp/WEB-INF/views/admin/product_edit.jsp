				...
				<div class="col-md-8 col-lg-4">
					<select class="form-select" aria-label="Default select example"
						...
						<c:forEach items="${maincategory }" var="maincategory">
							<option value="${maincategory.main_category }">
								${maincategory.main_name }</option>
			...
			<div class="row mb-3">
				...
				<div class="col-md-8 col-lg-9">
					<input name="product_no" type="text" class="form-control"
						id="product_no" value="${product.product_no }" placeholder="상품번호">
				</div>
			</div>
			...
			<div class="row mb-3">
				...
				<div class="col-md-8 col-lg-9">
					<input name="brand" type="text" class="form-control" id="brand"
						value="${product.brand }" placeholder="브랜드 / 제조사">
				</div>
			</div>
			...
			<div class="row mb-3">
				...
				<div class="col-md-8 col-lg-9">
					<input name="product_name" type="text" class="form-control"
						id="production" value="${product.product_name }" placeholder="상품명">
				</div>
			</div>
			...
			<div class="row mb-3">
				...
				<div class="col-md-8 col-lg-9">
					<input name="price" type="text" class="form-control"
						id="production" value="${product.price }" placeholder="개당 가격 (원)">
				</div>
			</div>
