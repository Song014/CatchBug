						...
						<div>
							<form action="orderHistory.do">
								<select name="searchTap">
								 ...
								 <input  class="dataTable-input"  type="text" name="searchWord" placeholder="검색어를 입력해 주세요.">
						...
						<div class="card-body">
							<div class="card-title">
								<div style="text-align: right;">
									<i class="bx bx-won"> 총 가격 : <span id="orderModal3"></span>
										<!-- 가격 들어갈 곳 -->
									</i>
								</div>
							</div>
        ...
        <div class = "row">
            <div class = "card">
                <div class = "card-body">
                    ...
                    <div class = "dataTable-container">
                        <form>
                            <table class = "table datatable dataTable-table" style = "text-align: center;">
                                <tr>
                                    <th scope = "col" data-sortable = ""><a href = "#" class = "dataTable-sorter">no</a>
                                    </th>
                                    <th scope = "col" data-sortable = ""><a href = "#"
                                                                            class = "dataTable-sorter">장바구니 번호</a></th>
                                    ...
                                    <th scope = "col" data-sortable = ""><a href = "#"
                                                                            class = "dataTable-sorter">장바구니 총 가격</a>
                                    </th>
                                    <th scope = "col" data-sortable = ""><a href = "#"
                                                                            class = "dataTable-sorter">배송지</a></th>
