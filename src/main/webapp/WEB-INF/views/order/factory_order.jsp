                                ...
                                <div class = "accordion-item">
                                    <h2 class = "accordion-header" id = "headingOne">
                                        <button class = "accordion-button collapsed" type = "button" data-bs-toggle = "collapse"
                                                data-bs-target = "#collapse${status.count }" aria-expanded = "false"
                                                aria-controls = "collapse${status.count }"> ${m.main_name}</button>
                                    </h2>
                                            ...
                                            <c:forEach var = "s" items = "${subCategory}">
                                                <c:if test = "${m.main_category eq s.main_category}">
                                                    <div class = "list-group">
                                                        ...
                                                        <button type = "button"
                                                                class = "list-group-item list-group-item-action getCategory"> ${s.sub_name }</button>
                                                    </div>
                                                </c:if>
                                            </c:forEach>
                                        </div>
                    ...
                    <div class = "col-lg-10">
                        ...
                        <div>
                            <div align = "right" class = "dataTable-top col-md-12">
                                <div class = "col-md-12">
                                    <input class = "dataTable-input" placeholder = "상품명을 입력해 주세요." type = "text"
                                           id = "searchWord">
                                        ...
                                        <c:forEach var = "list" items = "${product }" varStatus = "status">
                                            <tr>
                                                ...
                                                <th scope = "row" style = "width: 5%;"><a href = "#"><img
													...
													pattern="yyyy-MM-dd" />/${list.uuid}" alt = ""></a></th>
                                                ...
                                                <td style = "width: 40%; text-align: center;"><a
                                                        ...
                                                        id =${list.product_no }>${list.product_name
                                                        } </a></td>
                                                <td style = "width: 10%;"><fmt:formatDate value = "${list.add_day }"
                                                                                          pattern = "yyyy-MM-dd" /></td>
                                                <td style = "width: 5%;">${list.product_quantily }</td>
                                                <td style = "width: 5%;"><input type = "hidden" class = "hidden_price"
                                                                                value =${list.price }>
                                                        ${list.price }</td>
                                                <td style = "width: 5%;">
                                                    <button type = "button"
                                                            class = "btn btn-primary btn-sm addBucket">추가
                                                    </button>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                ...
                                <table class = "table" id = "bucket">
                                    ...
                                    <c:forEach var = "list" items = "${cartList }">
                                        <tr style = "text-align: center;">
                                            ...
                                            <td style = "width: 11.7%;"><input type = "number" name = "purchase_amount"
                                            ...
                                            <td style = "width: 10%;"><input type = "hidden" class = "hidden_price"
                                                                             value =${list.price }>${list.total }</td>
                                            <td style = "width: 5%;">
                                                <button type = "button" class = "btn btn-primary btn-sm delBucket">삭제
                                                </button>
                                            </td>
                                        </tr>
                                    </c:forEach>
                        ...
                        <div class = "d-grid gap-2 mt-3">
                            <input class = "btn btn-primary" type = "button" onclick = "location.href='orderPage.do'"
                                   value = "주문 확인"></input>
                        </div>
                    </div>
                </div>
