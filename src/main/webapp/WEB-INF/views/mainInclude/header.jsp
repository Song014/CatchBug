                            ...
                            <img src="assets/img/profile-img.jpg" alt="Profile" class="rounded-circle">
                                <c:choose>
                                    <c:when test="${member.level1 eq 1}">
                                        <span class="d-none d-md-block dropdown-toggle ps-2">${member.business_name }관리자님 안녕하세요</span>
                                    </c:when>
                                    <c:when test="${member.level1 eq 2}">
                                        <span class="d-none d-md-block dropdown-toggle ps-2">${member.business_name }가맹점님 안녕하세요</span>
                                    </c:when>
                                    <c:when test="${member.level1 eq 3}">
                                        <span class="d-none d-md-block dropdown-toggle ps-2">${member.business_name }가맹점님 가입승인이 완료되지 않았습니다.</span>
                                    </c:when>
                                    <c:otherwise>
                                        <span class="d-none d-md-block dropdown-toggle ps-2">로그인이 필요합니다</span>
                                    </c:otherwise>
                                </c:choose>
                            </a>
                                ...
                                <li class="dropdown-header">
                                    <c:choose>
                                        ...
                                        <li>
                                            ...
                                            <c:when test="${member.level1 eq 2}">
                                                <h6>${member.business_name }가맹점</h6>
                                            </li>
                                            <li>
                                                <hr class="dropdown-divider"></li>
...
<<<<<<< HEAD
                                                        ...
                                                        <li>
                                                            <hr class="dropdown-divider"></li>
                                                            <li>
                                                                <a class="dropdown-item d-flex align-items-center" href="sign_up.do">
                                                                    <i class="bi bi-person"></i>
                                                                    <span>회원가입</span>
                                                                </a>
                                                            </li>
