			...
			<ul class="sidebar-nav" id="sidebar-nav">
				...
				<li class="nav-item"><a class="nav-link collapsed"
					...
					<ul id="tables-nav" class="nav-content collapse "
						...
						<li><a href="factoryOrder.do?category=CPU"> <i
				...
				<!-- ======= 로그아웃 ======= -->
				<li class="nav-item"><a class="nav-link collapsed"
					href="login_page.do"> <i class="bi bi-box-arrow-in-right"></i>
						<span>로그아웃</span>
				</a></li>
				<!-- ======= 로그아웃 ======= -->

				<li class="nav-item"><a class="nav-link collapsed" href="/">
						<i class="bi bi-box-arrow-in-right"></i> <span>가맹점페이지가기
							(임시)</span>
				</a></li>
				<!-- End Login Page Nav -->
	...
	<c:otherwise>
		...
		<aside id="sidebar" class="sidebar">
			...
			<ul class="sidebar-nav" id="sidebar-nav">
				...
				<!-- ======= 회원가입 ======= -->
				<li class="nav-item"><a class="nav-link collapsed"
					href="sign_up.do"> <i class="bi bi-card-list"></i> <span>회원가입</span>
				</a></li>
				<!-- ======= 회원가입 끝 ======= -->
				...
				<!-- End Login Page Nav -->
				<!-- ======= 로그인 끝 ======= -->
				<li class="nav-item"><a class="nav-link collapsed" href="admin">
						<i class="bi bi-box-arrow-in-right"></i> <span>어드민페이지가기
							(임시)</span>
				</a></li>
				<!-- End Login Page Nav -->
			</ul>
