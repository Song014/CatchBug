					...
					<ul class="sidebar-nav" id="sidebar-nav">
						...
						<li class="nav-item"><a class="nav-link collapsed" data-bs-target="#components-nav"
								data-bs-toggle="collapse" href="#"> <i
									class="bi bi-menu-button-wide"></i><span>회사소개</span><i
						...
						<li class="nav-item"><a class="nav-link collapsed" data-bs-target="#forms-nav"
							...
							<ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
								...
								<li><a href="factory_franc_wait_list.do"> <i class="bi bi-circle"></i><span>가입승인 대기
											목록</span>
									</a></li>
						...
						<li class="nav-item"><a class="nav-link collapsed" data-bs-target="#tables-nav"
							...
							<ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
								...
								<li><a href="factoryStockList.do"> <i class="bi bi-circle"></i><span>본사 재고현황</span>
									</a></li>
								<li><a href="factoryOrder.do?category=CPU"> <i class="bi bi-circle"></i><span>본사 발주서
											작성</span>
									</a></li>
								<li><a href="factory_Order_History.do"> <i class="bi bi-circle"></i><span>본사 발주
											내역</span>
									</a></li>
			...
			<c:otherwise>
				...
				<aside id="sidebar" class="sidebar">
					...
					<ul class="sidebar-nav" id="sidebar-nav">
						...
						<!-- ======= Home ======= -->
						<li class="nav-item"><a class="nav-link " href="/"> <i class="bi bi-grid"></i> <span>HOME</span>
							</a></li>
						<!-- ======= Home END======= -->

						<!-- ======= 회사소개 ======= -->
						<li class="nav-item"><a class="nav-link collapsed" data-bs-target="#components-nav"
								data-bs-toggle="collapse" href="#회사소개"> <i
									class="bi bi-menu-button-wide"></i><span>회사소개</span><i
									class="bi bi-chevron-down ms-auto"></i>
							</a>
							<ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
						...
						<li class="nav-item"><a class="nav-link collapsed" data-bs-target="#forms-nav"
							...
							<ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
								...
								<li><a href="francOrderHistory.do"> <i class="bi bi-circle"></i><span>발주 내역</span>
									</a></li>
							</ul>
						</li>
						<!-- ======= 가맹점 관리 끝 ======= -->
