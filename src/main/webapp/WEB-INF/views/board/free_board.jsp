        ...
        <div class = "card-body">
            ...
            <div class = "row g-3">
                <div class = "col-md-12" style = "text-align: right;">
                    <form action = "freeBoard.do?page=1" method = "post" id = "search">
                        ...
                        </select> <input class = "dataTable-input" placeholder = "검색어를 입력해 주세요." type = "text"
                                         name = "searchWord">
            ...
            <table class = "table table-bordered" style = "text-align: center">
                ...
                <c:forEach var = "list" items = "${boardList }">
                    <tr>
                        <td>${list.board_no }</td>
                        <c:forEach var = "tap" items = "${tap}" varStatus = "status">
                                <c:if test = "${list.tap eq tap.tap}">
                        ...
                        <td>${list.cnt }</td>
                        <td><fmt:formatDate value = "${list.created_day }" pattern = "yyyy-MM-dd" /></td>
                    </tr>
                </c:forEach>
                </tbody>
                <tbody>
                    ...
                    <th colspan = "6">
                        <ul class = "pagination justify-content-center">
                            <% for (int i = startPage; i <= endPage; i++) {
                                if (i == nowPage) { %>
                            <li class = "paginate_button previous active"><a class = "page-link"
                                                                             href = "freeBoard.do?page=<%=i%>&searchTap=<%=searchTap%>&searchWord=<%=keyWord%>"><%=i%>
                            </a></li>
                            <% } else { %>
