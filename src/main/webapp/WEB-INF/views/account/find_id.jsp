                                ...
                                <form class="row g-3 needs-validation" novalidate>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group has-validation">
                                            <input type="text" name="emailid" class="form-control" id="yourUsername"
                                                required>
                                            <span class="input-group-text" id="inputGroupPrepend">@</span>
                                            <input type="text" name="emaildomain" class="form-control" id="yourUsername"
                                                required>
                                    ...
                                    <p>
                                        <button type="submit" style="border-radius: 5px;">아이디 찾기</button>
                                    </p>
                                </form>

                                <p>※ 위 방법으로 아이디를 찾을수 없는 경우 <a href="#" target="_blank">고객센터</a>에 문의해주세요. ※</p>
