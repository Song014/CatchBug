...
public class OrderController {
    ...
    private OrderController() {
        client = new IamportClient("4531801211644015", "FwlsbR1eS5ipldOSWyK9K23UfoV0pnvo4GT3Q0SryW6txJ9B9ZDhLdVxVlweIUsrsNGAYAaIjRHBhoyu");
    }
    ...
    public IamportResponse<PagedDataList<Payment>> paymentByImpStatus(Model model, Locale locale, HttpSession session, @PathVariable(value = "status") String status) throws IamportResponseException, IOException {
